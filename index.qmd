...
*I'm not familiar with baseball but I think with high altitude the air will be thinner so when the ball in airborn it will has less air resistance and therefore fly further or faster.*

- Is Coors Field affected by high altitude?

*To be honest I don't even know where this place is but according to AI it is at 5,280ft which is considered high altitude. So I would imagine COL is somewhat affected by high altitude.*
:::
...
*There are 2429 games in the 2021 dataset and 2430 games in the 2010 dataset.*

- Why do we aggregate individual games into stadium averages before we start the visualization process?

*We aggregate individual games into statdium averages because we are trying to tell if this one stadium(COL) is the most run-friendely one. If we don't aggregate there will be too many data points fot one single stadium which is hard to tell anything.*
:::
...
*It could be helpful but the locaation is wrong. It is not pointing at the correct bar which is the top one.*
